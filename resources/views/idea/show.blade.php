        ...
        <div class="flex justify-between items-center ">
            ...
            <div class="gap-x-3 flex items-center">
              ...
              <form method="POST" action="{{route('idea.destroy', $idea)}}">
                  @csrf
                  @method('DELETE')
                  <button x-data class="btn btn-outlined text-red-500">Delete</button>
              </form>
            </div>
                           ...
                           <x-card>
                               <form action="{{route('step.update',$step)}}" method="POST">
                                   ...
                                   <div class="flex items-center gap-x-3">
                                       <div>
                                           <button type="submit" role="checkbox" class=" size-5 flex items-center justify-center rounded-lg
                                  text-primary-foreground {{$step->completed ? 'bg-primary':'border border-primary'}} ">&check;</button>
